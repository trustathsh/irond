...
/**
 * Simple Request to delete a running subscription
 *
 * @version 0.1
 * @author aw
 *
 ...
 *
 */
public class SubscribeDelete extends SubSubscribeRequest {

	public SubscribeDelete(String n) throws RequestCreationException {
		super(n);
	}
}
