 ...
 * {@link ResultMarshaller} implementation.
 *
 * @since 0.2.0
 * @author aw
 */
public abstract class ResultMarshallerFactory {

	public static ResultMarshaller newResultMarshaller() {
		return new JaxbResultMarshaller();
	}
}
