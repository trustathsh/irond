...
/**
 * Simply indicates that a subscribeReceived has to be send out on the
 * given channel.
 *
 * @author aw
 *
 */
public class SubscribeReceivedResult extends Result {

	public SubscribeReceivedResult(ChannelIdentifier channelId,
