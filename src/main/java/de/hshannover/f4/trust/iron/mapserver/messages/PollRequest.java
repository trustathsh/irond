...
/**
 * Simple {@link Request} implementation to represent a poll operation.
 *
 * @author aw
 *
 */
public class PollRequest extends RequestWithSessionId {

	PollRequest(String sid) throws RequestCreationException {
		super(sid);
	}

	@Override
	public void dispatch(EventProcessor ep) throws AccessDeniedException {
		ep.processPollRequest(this);
	}
}
