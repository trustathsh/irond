...
/**
 * Simply indicates that a publishReceived has to be send out on the
 * given channel.
 *
 * @author aw
 *
 */
public class PublishReceivedResult extends Result {

	public PublishReceivedResult(ChannelIdentifier channelId,
