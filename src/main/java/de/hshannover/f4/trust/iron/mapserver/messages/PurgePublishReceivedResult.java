...
/**
 * /**
 * Simply indicates that a purgePublisherReceived has to be send out on the
 * given channel.
 *
 * @author aw
 *
 */
public class PurgePublishReceivedResult extends Result {

	public PurgePublishReceivedResult(ChannelIdentifier channelId,
