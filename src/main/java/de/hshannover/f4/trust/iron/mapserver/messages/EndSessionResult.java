...
/**
 * Class which simply indicates that a endSessionResult response has to
 * be send out on the given channel.
 *
 * @author aw
 *
 */
public class EndSessionResult extends Result {

	public EndSessionResult(ChannelIdentifier channelId, ClientIdentifier clientId) {
