...
/**
 * Simple {@link Request} implementation to indicate a renewSession operation.
 *
 * @author aw
 *
 */
public class RenewSessionRequest extends RequestWithSessionId {

	RenewSessionRequest(String sid) throws RequestCreationException {
		super(sid);
	}

	@Override
	public void dispatch(EventProcessor ep) {
		ep.processRenewSessionRequest(this);
	}
}
