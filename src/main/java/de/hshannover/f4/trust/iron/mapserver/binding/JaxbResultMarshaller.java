...
import de.hshannover.f4.trust.iron.mapserver.datamodel.meta.MetadataValidationEnum;
import de.hshannover.f4.trust.iron.mapserver.datamodel.search.PollResult;
import de.hshannover.f4.trust.iron.mapserver.datamodel.search.ResultItem;
	...
	public InputStream marshal(Result result) {
		...
		if (result instanceof ErrorResult) {
			...
			is = createDumpResponse(dr.getDumpResult());
				...
				de.hshannover.f4.trust.iron.mapserver.messages.EndSessionResult) {
			...
			is = createPurgePublisherResponse();
				...
				de.hshannover.f4.trust.iron.mapserver.messages.RenewSessionResult) {
