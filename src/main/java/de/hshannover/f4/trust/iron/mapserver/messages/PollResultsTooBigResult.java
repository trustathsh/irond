...
/**
 * Simple {@link Result} sublass to be used if a PollResultsTooBig message
 * has to be sent to a client.
 *
 * @author aw
 *
 */
public class PollResultsTooBigResult extends Result {

	public PollResultsTooBigResult(ChannelIdentifier channelId,
