...
abstract class SearchResultImpl implements ModifiableSearchResult {
	...
	/* (non-Javadoc)
	 * @see de.hshannover.f4.trust.iron.mapserver.datamodel.search.SearchResult#getResultItems()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.hshannover.f4.trust.iron.mapserver.datamodel.search.SearchResult#getName()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.hshannover.f4.trust.iron.mapserver.datamodel.search.SearchResult#getType()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.hshannover.f4.trust.iron.mapserver.datamodel.search.SearchResult#isEmpty()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.hshannover.f4.trust.iron.mapserver.datamodel.search.ModifieableSearchResult#addMetadataContainer(de.hshannover.f4.trust.iron.mapserver.datamodel.graph.GraphElement)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.hshannover.f4.trust.iron.mapserver.datamodel.search.ModifieableSearchResult#addMetadata(de.hshannover.f4.trust.iron.mapserver.datamodel.graph.GraphElement, java.util.List)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.hshannover.f4.trust.iron.mapserver.datamodel.search.ModifieableSearchResult#addResultItem(de.hshannover.f4.trust.iron.mapserver.datamodel.search.ResultItem)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.hshannover.f4.trust.iron.mapserver.datamodel.search.ModifieableSearchResult#addResultItems(java.util.List)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.hshannover.f4.trust.iron.mapserver.datamodel.search.SearchResult#sameNameAndType(de.hshannover.f4.trust.iron.mapserver.datamodel.search.SearchResult)
	 */
	@Override
