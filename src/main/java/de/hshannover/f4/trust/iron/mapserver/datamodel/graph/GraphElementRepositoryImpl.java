...
import de.hshannover.f4.trust.iron.mapserver.utils.MultiArrayListMap;
import de.hshannover.f4.trust.iron.mapserver.utils.MultiMap;
...
public class GraphElementRepositoryImpl implements GraphElementRepository {
	...
	/* (non-Javadoc)
	 * @see de.hshannover.f4.trust.iron.mapserver.datamodel.graph.GraphElementRepository#getNodeFor(de.hshannover.f4.trust.iron.mapserver.datamodel.identifiers.Identifier)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.hshannover.f4.trust.iron.mapserver.datamodel.graph.GraphElementRepository#getLinkFor(de.hshannover.f4.trust.iron.mapserver.datamodel.identifiers.Identifier, de.hshannover.f4.trust.iron.mapserver.datamodel.identifiers.Identifier)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.hshannover.f4.trust.iron.mapserver.datamodel.graph.GraphElementRepository#getAllNodes()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.hshannover.f4.trust.iron.mapserver.datamodel.graph.GraphElementRepository#getAllLinks()
	 */
	...
	/* (non-Javadoc)
	 * @see de.hshannover.f4.trust.iron.mapserver.datamodel.graph.GraphElementRepository#getAllElements()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.hshannover.f4.trust.iron.mapserver.datamodel.graph.GraphElementRepository#dumpContents()
	 */
	@Override
