...
/**
 * This event represents a simple notification if the {@link DataModelService}
 * has reported the availability of a new PollResult for a MAPC.
 *
 * @author aw
 *
 */
public class PollResultAvailableEvent implements Event {

	/**
	 * the session-id of the corresponding MAPC
	 */
	...
	public void dispatch(EventProcessor ep) {
		ep.processPollResultAvailableEvent(this);
	}
}
