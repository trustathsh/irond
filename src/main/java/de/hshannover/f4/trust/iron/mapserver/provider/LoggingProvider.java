...
public class LoggingProvider {
	...
	public static Logger getTheLogger() {
		return Logger.getLogger("de.hshannover.f4.trust.irond.proc");
	}

	public static Logger getRawRequestLogger() {
		return Logger.getLogger("de.hshannover.f4.trust.irond.rawrequests");
	}

	public static Logger getDecisionRequestLogger() {
		return Logger.getLogger("de.hshannover.f4.trust.irond.pdprequests");
	}

	public static Logger getRawDecisionRequestLogger() {
		return Logger.getLogger("de.hshannover.f4.trust.irond.pdprequests.raw");
	}
}
