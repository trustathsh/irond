 ...
 * #L%
 */
package de.hshannover.f4.trust.iron.mapserver.stubs;
...
/**
 * Stub for {@link IfmapPep}
 *
 * @author aw
 *
 */
public class IfmapPepStub implements IfmapPep {

	@Override
	public List<MetadataHolder> isSearchAuthorized(Publisher pub,
			List<MetadataHolder> mh) {
		return mh;
	}

	@Override
	public boolean isAuthorized(Publisher purger, String publisherId) {
